...
import tech.brenoepic.commands.BlockMentionCommand;
...
public class Extras {
  public static void loadTexts() {
    ...
    Emulator.getTexts().register("commands.cmd_mention_user_success", "You have successfully mentioned %var%!");
    ...
    Emulator.getTexts().register("commands.cmd_mention_room.look", "${image.library.url}notifications/fig/%LOOK%.png");
    Emulator.getTexts().register("commands.error.cmd_mention.user_blocksmention", "The MentionUser does not want to be mentioned.");
    Emulator.getTexts().register("commands.error.cmd_mention.user_mention_blocked", "%var% do not want to be mentioned.");
    Emulator.getTexts().register("commands.error.cmd_mention.unknown_error", "An unknown error occurred.");
    Emulator.getTexts().register("cmd_blockmention_keys", "blockmention;mentionsoff");
    Emulator.getTexts().register("commands.cmd_mention.message.multi.sent", "You have successfully mentioned %var% users!");
    ...
    Emulator.getTexts().register("commands.cmd_mention.timeout_message", "You should wait more %var% seconds to mention again!");
    ...
    Emulator.getConfig().register("commands.cmd_mention_friends.message.show_username.enabled", "1");
